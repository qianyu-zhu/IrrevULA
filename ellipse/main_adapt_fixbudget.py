...
from getoptJ import getoptJ, getnoptJ, getJ, getoptJ_JSJ, getoptJ_JSJS, getoptJ_JSSJ
...
def main(M,h,K,sigma_true,path):
    ...
    # print('statsY_JSJ_all.shape', statsY_JSJ_all.shape)
    # print('statsY_JSJS_all.shape', statsY_JSJS_all.shape)
    # print('statsY_JSSJ_all.shape', statsY_JSSJ_all.shape)
    # print('statsYadapt_all.shape', statsYadapt_all.shape)
    ...
    # np.save(f'{path}/statsY_JSJ_4D_Gaussian_K{K}_M{M}_h{h}.npy', statsY_JSJ_all) # (M, N, N_stats)
    # np.save(f'{path}/statsY_JSJS_4D_Gaussian_K{K}_M{M}_h{h}.npy', statsY_JSJS_all) # (M, N, N_stats)
    # np.save(f'{path}/statsY_JSSJ_4D_Gaussian_K{K}_M{M}_h{h}.npy', statsY_JSSJ_all) # (M, N, N_stats)
    # np.save(f'{path}/statsYadapt_4D_Gaussian_K{K}_M{M}_h{h}.npy', statsYadapt_all) # (M, N, N_stats)
