...
echo "ellipse, fix budget, adaptive"

# Define common parameters
common_params="--M 64 --K 10000 --path Dec_14_adapt_fixbudget"

echo $common_params
# Function to run simulations for a given method
for h in 0.08 0.16 0.24 0.32 0.4; do
    echo "h = $h"
    srun python -u main_adapt_fixbudget.py $common_params --h $h
done
